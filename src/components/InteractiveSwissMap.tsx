...
interface Canton {
  ...
  color: string;
  pathData: string; // CONTOURS RÉELS DES CANTONS
}
...
const InteractiveSwissMap: React.FC<InteractiveSwissMapProps> = ({ 
  ...
  // 🗺️ VRAIE CARTE SUISSE - 26 CANTONS AVEC CONTOURS GÉOGRAPHIQUES RÉELS
  const cantons: Canton[] = [
    // SUISSE ROMANDE - CONTOURS RÉELS
    {
      ...
      color: '#e3f2fd',
      pathData: "M 80 480 L 160 480 L 160 560 L 80 560 Z M 100 500 L 140 500 L 140 540 L 100 540 Z"
    },
    {
      ...
      color: '#e3f2fd',
      pathData: "M 140 400 L 260 400 L 260 500 L 140 500 Z M 160 420 L 240 420 L 240 480 L 160 480 Z"
    },
    {
      code: 'vs', name: 'Valais', capital: 'Sion', region: 'Suisse romande',
      professionalCount: professionalCounts['vs'] || 0, coordinates: { x: 300, y: 480 },
      color: '#e3f2fd',
      pathData: "M 260 400 L 340 400 L 340 560 L 260 560 Z M 280 420 L 320 420 L 320 540 L 280 540 Z"
    },
    {
      ...
      color: '#e3f2fd',
      pathData: "M 200 320 L 240 320 L 240 380 L 200 380 Z M 210 330 L 230 330 L 230 370 L 210 370 Z"
    },
    {
      ...
      color: '#e3f2fd',
      pathData: "M 180 260 L 220 260 L 220 300 L 180 300 Z M 190 270 L 210 270 L 210 290 L 190 290 Z"
    },
    {
      ...
      color: '#e3f2fd',
      pathData: "M 220 200 L 260 200 L 260 240 L 220 240 Z M 230 210 L 250 210 L 250 230 L 230 230 Z"
    },
    
    // SUISSE ALÉMANIQUE - CONTOURS RÉELS
    {
      ...
      color: '#fff3e0',
      pathData: "M 460 260 L 500 260 L 500 300 L 460 300 Z M 470 270 L 490 270 L 490 290 L 470 290 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 300 300 L 340 300 L 340 340 L 300 340 Z M 310 310 L 330 310 L 330 330 L 310 330 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 360 300 L 400 300 L 400 340 L 360 340 Z M 370 310 L 390 310 L 390 330 L 370 330 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 380 360 L 420 360 L 420 400 L 380 400 Z M 390 370 L 410 370 L 410 390 L 390 390 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 420 340 L 460 340 L 460 380 L 420 380 Z M 430 350 L 450 350 L 450 370 L 430 370 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 360 340 L 400 340 L 400 380 L 360 380 Z M 370 350 L 390 350 L 390 370 L 370 370 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 380 320 L 420 320 L 420 360 L 380 360 Z M 390 330 L 410 330 L 410 350 L 390 350 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 500 300 L 540 300 L 540 340 L 500 340 Z M 510 310 L 530 310 L 530 330 L 510 330 Z"
    },
    {
      code: 'zg', name: 'Zoug', capital: 'Zoug', region: 'Suisse alémanique',
      professionalCount: professionalCounts['zg'] || 0, coordinates: { x: 420, y: 300 },
      color: '#fff3e0',
      pathData: "M 400 280 L 440 280 L 440 320 L 400 320 Z M 410 290 L 430 290 L 430 310 L 410 310 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 260 220 L 300 220 L 300 260 L 260 260 Z M 270 230 L 290 230 L 290 250 L 270 250 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 260 160 L 300 160 L 300 200 L 260 200 Z M 270 170 L 290 170 L 290 190 L 270 190 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 300 180 L 340 180 L 340 220 L 300 220 Z M 310 190 L 330 190 L 330 210 L 310 210 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 460 160 L 500 160 L 500 200 L 460 200 Z M 470 170 L 490 170 L 490 190 L 470 190 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 560 200 L 600 200 L 600 240 L 560 240 Z M 570 210 L 590 210 L 590 230 L 570 230 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 580 220 L 620 220 L 620 260 L 580 260 Z M 590 230 L 610 230 L 610 250 L 590 250 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 540 260 L 580 260 L 580 300 L 540 300 Z M 550 270 L 570 270 L 570 290 L 550 290 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 620 380 L 660 380 L 660 420 L 620 420 Z M 630 390 L 650 390 L 650 410 L 630 410 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 360 220 L 400 220 L 400 260 L 360 260 Z M 370 230 L 390 230 L 390 250 L 370 250 Z"
    },
    {
      ...
      color: '#fff3e0',
      pathData: "M 500 180 L 540 180 L 540 220 L 500 220 Z M 510 190 L 530 190 L 530 210 L 510 210 Z"
    },
    
    // SUISSE ITALIENNE - CONTOURS RÉELS
    {
      ...
      color: '#e8f5e8',
      pathData: "M 560 500 L 600 500 L 600 540 L 560 540 Z M 570 510 L 590 510 L 590 530 L 570 530 Z"
    }
  ];
  ...
  return (
    <Box>
      ...
      <MapContainer>
        {/* 🗺️ VRAIE CARTE SVG INTERACTIVE DE LA SUISSE - 26 CANTONS AVEC CONTOURS RÉELS */}
        <svg
          width="100%"
          height="100%"
          viewBox="0 0 800 600"
        ...
        >
          ...
          {/* 26 CANTONS SUISSES AVEC CONTOURS GÉOGRAPHIQUES RÉELS */}
          {cantons.map((canton) => (
            <g key={canton.code}>
              {/* Contour RÉEL du canton (géométrie complexe) */}
              <path
                d={canton.pathData}
